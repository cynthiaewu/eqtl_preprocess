...
tail -n +2 "${genotype}_intersect" | split -d -l 500 - --filter='sh -c "{ head -n 1  "${genotype}_intersect"; cat; } > $FILE"' "${genotype_segments}/genotype_"
...
do
    ...
    #echo $file
    #echo $file; echo $file $file; echo $n;
    #echo $n;
