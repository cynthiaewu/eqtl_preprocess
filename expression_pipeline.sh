...
bedtools intersect -a "${expr_label}.expr.tpm.rename.bed" -b data/rn6_segdups.bed -v -header > "${expr_label}.expr.tpm.rename.nosegdups.bed"  
...
python filter_expression.py -f "${expr_label}.expr.tpm.rename.nosegdups.bed" -o "${expr_label}.expr_filter_normalize_inverse_proteincoding_nosegdups.tsv" -p $expr_label
